export default function ProfilePage(){
    return(
        <div className="min-h-screen bg-[#e6efff] flex items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl">
                ...
                <div>
                    ...
                    {Array.from({ length: 6 }).map((_, index) => (
                        ...
                        {/* Tombol bulat kecil di pojok luar kanan bawah */}
                        <button
                            className="absolute -bottom-2 -right-2 w-6 h-6 rounded-full bg-yellow-400 flex items-center justify-center shadow-md p-0"
                ...
                <button className="bg-gradient-to-r from-pink-500 to-orange-400 text-white px-6 py-2 rounded-full font-semibold">
                    Save Changes
                </button>
                </div>
            </div>
